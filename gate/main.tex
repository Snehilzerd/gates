...
A = 200
\end{align*}
Expected number of groups tested positive (b) :
\begin{align*}
b &= 200 * F_{X}(4) \\ &= 200 * 0.4096 \\ &= 81.92
\end{align*}
Now we will test all the 5 individuals of the group tested positive seperately \\
Expected number of new individual tests (B) :
\begin{align}
B &= 5 * b \\ &= 5 * 81.92 \\ &= 409.6
\end{align}
